...
#shortcuts
TOLIKSLIB := libs/ToliksLib

#variables
APPNAME := main.exe
DEBUG := -g
FLAGS := -Wall -fmax-errors=10 -Wshadow #-funroll-loops
LIBSTOCOMPILE := $(TOLIKSLIB)
DEPENDENCIES := $(TOLIKSLIB)/src/Tolik
LIBS := -I$(TOLIKSLIB)/src -I$(TOLIKSLIB)/libs/glm -I$(TOLIKSLIB)/libs/glad/include -I$(TOLIKSLIB)/libs/SDL2/include -I$(LIBDIR)/stb_image -L$(TOLIKSLIB)/libs/SDL2/lib -lmingw32 -lSDL2main -lSDL2
THIRDPARTY := $(TOLIKSLIB)/libs/glad/src/glad.o $(TOLIKSLIB)/build
